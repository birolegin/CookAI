...
export default function AI() {
    ...
    const endpoint = "https://synthopenaich.openai.azure.com/openai/deployments/synth4vision/chat/completions?api-version=2024-02-15-preview";
        ...
        <View style={styles.container}>
            ...
            {selectedImage && (
                <View style={styles.indicatorContainer}>
                    <Text style={styles.indicatorText}>Image Selected</Text>
                </View>
            )}
        </View>
    );    
...
const styles = StyleSheet.create({
    ...
    loadingContainer: {
        ...
        justifyContent: 'center',
        alignItems: 'center',
        backgroundColor: 'rgba(255, 231, 175, 0.8)', // Semi-transparent background
        position: 'absolute',
        top: 0,
        bottom: 0,
        left: 0,

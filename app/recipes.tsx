...
export default function RecipesScreen() {
    ...
    useEffect(() => {
        const fetchRecipes = async () => {
            ...
            const q = query(recipesRef, where('ingredients', 'array-contains-any', selectedIngredients));
        ...
        return (
            ...
            >
                ...
                <View style={styles.recipeInfo}>
                    ...
                    <Text style={styles.recipeDetails}>Pişirme Süresi: {item.cookTime} dakika</Text>
                </View>
            </TouchableOpacity>
        );
    };
